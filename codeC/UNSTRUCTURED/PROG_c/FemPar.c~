/* FemPar.c */
/* A program using MPI (with C binding) compute a parallel finite element solution to a linear self-adjoint
...
/* I add here the initialization of matrices and vectorsi (should know if calloc does it or not?)*/
   for (I=0; I<IntNodes; I++) {
       Fp[I]=0.0; 
       Vp[I]=0.0;
   ...
   for (I=0; I<Nodes; I++)
       if (Node[I].Type == 1)
          printf(" %f %f %f\n",Node[I].Pos[0],Node[I].Pos[1],Vp[Node[I].Local]);
       else if (Node[I].Type > 1)
          printf(" %f %f %f\n",Node[I].Pos[0],Node[I].Pos[1],Vs[Node[I].Local]);
